...
function EducationSection() {
  return (
    <section className="education-section" style={{ fontFamily: 'Segoe UI, Arial, sans-serif', marginBottom: '0.5rem' }}>
      ...
      <div className="edu-timeline" style={{ position: 'relative', marginLeft: '0.9rem', paddingLeft: '1.1rem', maxWidth: 'none' }}>
        <div className="edu-item" style={{ position: 'relative', marginBottom: '0.75rem' }}>
          <div style={{ fontWeight: 700, color: '#fff', fontSize: '1.13rem', marginBottom: '0.05rem', position: 'relative', top: '-0.05rem' }}>B.Sc. (Hons), Computer Science (Data Analytics) <span style={{ color: '#ffd600', fontWeight: 400, fontSize: '1rem' }}>(2021 - 2026)</span></div>
          <div style={{ color: '#ffd600', fontWeight: 600, fontSize: '1rem', marginBottom: '0.15rem' }}>Trent University, Peterborough, ON</div>
          <div style={{ color: '#e0e0e0', fontSize: '1rem', marginBottom: '0.15rem' }}><b>Relevant Coursework:</b> Front-End Web Development, Back-End Web Development, Cybersecurity, Software Design & Modelling, Applied AI & Machine Learning, Data Visualization, Database Management Systems, Data Structures & Algorithms I & II, Modelling & Simulation, Systems Analysis and Design</div>
          <div style={{ color: '#e0e0e0', fontSize: '1rem', marginBottom: '0.15rem' }}><b>Projects:</b>
            <ul style={{ margin: '0.15rem 0 0.15rem 1rem', color: '#e0e0e0', fontSize: '1rem' }}>
              <li style={{ marginBottom: '0.25rem' }}>Developed a puzzle-based game prototype (digital & analog versions).</li>
...
function ExperienceSection() {
  return (
    <section className="experience-section" style={{ fontFamily: 'Segoe UI, Arial, sans-serif', marginBottom: '0' }}>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.9rem' }}>
      ...
      <div className="exp-timeline" style={{ position: 'relative', marginLeft: '0.9rem', paddingLeft: '1.1rem', maxWidth: 'none' }}>
        <div className="exp-item" style={{ position: 'relative', marginBottom: '0.75rem' }}>
          <div style={{ fontWeight: 700, color: '#fff', fontSize: '1.13rem', marginBottom: '0.05rem', position: 'relative', top: '-0.05rem' }}>MOR Engineering Analyst Intern <span style={{ color: '#ffd600', fontWeight: 400, fontSize: '1rem' }}>(January 2026 – August 2026)</span></div>
        ...
        <div className="exp-item" style={{ position: 'relative', marginBottom: '0.75rem' }}>
          ...
          <div style={{ color: '#e0e0e0', fontSize: '1rem', marginBottom: '0.15rem' }}>
            <ul style={{ margin: '0.15rem 0 0.15rem 1rem', color: '#e0e0e0', fontSize: '1rem' }}>
              <li style={{ marginBottom: '0.25rem' }}>Developed and deployed internal software tools and automated workflows using Python, SQL, and database systems, increasing operational efficiency by 25%.</li>
              <li style={{ marginBottom: '0.25rem' }}>Designed and implemented reporting systems with data visualization dashboards, reducing manual reporting time from 2 hours to under 30 minutes.</li>
              <li style={{ marginBottom: '0.25rem' }}>Provided technical support for internal software systems and created technical documentation, improving troubleshooting time by 40%.</li>
              <li style={{ marginBottom: '0.25rem' }}>Created and presented 100+ interactive 3D renovation models annually using digital modelling tools, improving customer engagement and technical communication.</li>
