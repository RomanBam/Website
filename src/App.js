          ...
          <>
            <section className="about-section">
              ...
              <p className="about-desc">
                ...
                On the development side, I'm skilled in modern web technologies including React.js, Next.js, Flask, and Streamlit for building responsive applications. I work with multiple programming languages (Python, JavaScript, SQL, C#, Java) and leverage tools like AWS, Docker, and Git for deployment and version control. My focus is on creating clean, efficient code and intuitive user experiences that bridge the gap between complex AI capabilities and practical applications.
              </p>
            </section>
